...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        let knownRideIds = [@foreach($rides as $r) {{ $r->id }}, @endforeach];

        function fetchAvailableRides() {
            fetch('{{ route("driver.rides.poll-available") }}')
                .then(res => res.json())
                .then(data => {
                    if (data.rides) {
        ...
        function addNewRideCard(ride) {
            ...
            newCard.innerHTML = `
                ...
                <div class="flex justify-between items-center mt-6 py-4 border-t border-emerald-200/50 highlight-border">
                    <div class="flex items-center gap-2">
                    ...
                    <div class="text-right">
                        <p class="text-[10px] font-black tracking-widest uppercase text-emerald-700 leading-none mb-0.5">Distance</p>
